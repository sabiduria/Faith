...
class EquipmentsController extends AppController
{
    ...
    {
        $equipment = $this->Equipments->get($id, contain: ['Churchs', 'Maintenances']);
    ...
    public function add()
    {
        ...
        $churchs = $this->Equipments->Churchs->find('list', limit: 200)->all();
        $this->set(compact('equipment', 'churchs'));
    }
