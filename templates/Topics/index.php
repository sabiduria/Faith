            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <?= $this->Form->postLink(__('Supprimer'), ['action' => 'delete', $topic->id], ['class' => 'btn btn-danger btn-sm', 'confirm' => __('Voulez-vous supprimer cette information ?')]) ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
...
<script>
    $(document).ready(function() {
        $('#DataForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '<?= $this->Url->build(["controller" => 'Topics', 'action' => 'insert']) ?>',
                method: 'POST',
                data: formData,
