...
<div class="mt-3">
    ...
    <?= $this->Html->link(__('Nouveau Project'), ['action' => 'add'], ['class' => 'btn btn-success btn-sm mb-3']) ?>
        ...
        <table id="scroll-vertical" class="table table-bordered text-nowrap w-100 TableData">
            <thead>
                <tr>
                    ...
                    <th><?= $this->Paginator->sort('project_status') ?></th>
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="NewItem"
    ...
    <div class="offcanvas-header border-bottom border-block-end-dashed">
        <h5 class="offcanvas-title" id="offcanvasRightLabel1">Nouveau Projects</h5>
...
<script>
    $(document).ready(function() {
        $('#DataForm').on('submit', function(e) {
            ...
            $.ajax({
                url: '<?= $this->Url->build(["controller" => 'Projects', 'action' => 'insert']) ?>',
                method: 'POST',
                data: formData,
